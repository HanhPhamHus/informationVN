<?php
ob_start();
session_start();//biến tồn trại trong suốt quá trình di chuyển giữa các trang web 
require "lib/dbCon.php";
require "lib/trangchu.php";//khai báo hàm để dùng
if(isset($_GET["p"]))
    $p= $_GET["p"];
else {
    $p = "";
...
//kiểm tra loginư
    ...
    if(isset($_POST["btnLogin"])){
        ...
        $pa=$_POST["txtPa"];
        $pa=md5( $pa);
        $con= mysqli_connect("localhost","root","","informationvn");
        $qr = "
            SELECT *  FROM users
            WHERE Username= '$un'
            AND Password ='$pa'
...
<title>Informations VietNam</title>
...
<div id="wrap-vp">
	<div id="header-vp">
    	<div id="logo"><img style="width:204px;height:59px" src="images/logo2.jpg" /></div>
    </div>
    ...
    <div id="footer">
        ...
        ?>
        <div class="ft-bot">
            <div class="bot1"><img src="images/logo2.jpg" /></div>
            <div class="bot2">
                     <p>© <span>Copyright 1997 InformationVn,</span>  All rights reserved</p>
                     <p>® InformationVn giữ bản quyền nội dung trên website này.</p>
            </div>
            <div class="bot3">
                
                     <p><a href="#">InformationVn tuyển dụng</a>   <a href="http://polyad.net/Polyad/Lien-he.htm">Liên hệ quảng cáo</a> / <a href="/contactus">Liên hệ Tòa soạn</a></p>
